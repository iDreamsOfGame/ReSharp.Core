...
namespace ReSharp.Compression
{
    ...
    public static class Deflate
    {
        ...
        /// <summary>
        /// Compress <see cref="string"/> which encoded in <c>encoding</c> into binary data by using the Deflate algorithm.
        /// </summary>
        ...
        /// <summary>
        /// Compress binary data into Base64 <see cref="string"/> by using the Deflate algorithm.
        /// </summary>
        /// <param name="input">The original binary data. </param>
        /// <param name="level">One of the enumeration values that indicates whether to emphasize speed or compression efficiency when compressing data to the stream. </param>
        ...
        /// <summary>
        /// Compress <see cref="string"/> which encoded in <c>encoding</c> into Base64 <see cref="string"/> by using the Deflate algorithm.
        /// </summary>
        /// <param name="source">The original <see cref="string"/>. </param>
        /// <param name="encoding">The <see cref="Encoding"/> instance to get binary data from the original <see cref="string"/>. </param>
        /// <param name="level">One of the enumeration values that indicates whether to emphasize speed or compression efficiency when compressing data to the stream. </param>
        ...
        /// <summary>
        /// Decompress into <see cref="string"/> which encoded in <c>encoding</c> from input binary data by using the Deflate algorithm.
        /// </summary>
        /// <param name="input">The compressed binary data. </param>
        ...
        /// <summary>
        /// Decompress into binary data from Base64 <see cref="string"/> by using the Deflate algorithm.
        /// </summary>
        ...
        /// <summary>
        /// Decompress into <see cref="string"/> which encoded in <c>encoding</c> from Base64 <see cref="string"/> by using the Deflate algorithm.
        /// </summary>
        /// <param name="source">The Bass64 <see cref="string"/>. </param>
        /// <param name="encoding">The <see cref="Encoding"/> instance to get binary data from the original binary data. </param>
        /// <returns>The original <see cref="string"/>. </returns>
